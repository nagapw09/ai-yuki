...
pub enum ContentBlock {
    ...
    ///
    /// Данные передаются как base64, а не ссылкой: файл на диске пришлось бы
    /// куда-то класть, чем-то раздавать и потом убирать, а снимок экрана — это
    /// содержимое рабочего стола пользователя, которому на диске делать нечего.
    Image {
        media_type: String,
        data: String,
    },
